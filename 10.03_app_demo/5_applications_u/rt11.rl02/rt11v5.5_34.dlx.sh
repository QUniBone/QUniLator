...
p image /var/lib/qunilator/images/dl/rt11v5.5.rl02.dsk # mount image file with test pattern
...
p runstopbutton 0	# released: "LOAD"
p powerswitch 1		# power on, now in "load" state
p image /var/lib/qunilator/images/dl/rt11v5.5_games_34.rl02.dsk	# mount image file with test pattern
p runstopbutton 1	# press RUN/STOP, will start
...
p runstopbutton 0	# released: "LOAD"
p powerswitch 1		# power on, now in "load" state
p image /var/lib/qunilator/images/dl/scratch2.rl02.dsk 	# mount image file with test pattern
p runstopbutton 1	# press RUN/STOP, will start
...
p runstopbutton 0	# released: "LOAD"
p powerswitch 1		# power on, now in "load" state
p image /var/lib/qunilator/images/dl/scratch3.rl02.dsk 	# mount image file with test pattern
p runstopbutton 1	# press RUN/STOP, will start
