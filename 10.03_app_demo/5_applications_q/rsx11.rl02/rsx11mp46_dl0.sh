...
p image /var/lib/qunilator/images/dl/rsx11mp46-rl02pg.rl02.dsk # mount image file
...
p runstopbutton 0	# released: "LOAD"
p powerswitch 1		# power on, now in "load" state
p image /var/lib/qunilator/images/dl/scratch1.rl02.dsk	# mount image file with test pattern
p runstopbutton 1	# press RUN/STOP, will start
