...
- **A microSD card, 8 GB or larger.** The release itself takes about 2.6 GB;
  the rest is where your disk and tape images live, which is what the 8 GB is
  for. A 4 GB card boots and runs with room for a pack or two. Buy a good one:
  unlike in a camera, Debian is on it the whole time, and speed and reliability
  both matter.
